/*** Object: StoredProcedure [Erp].[_ZFW_APInvoiceAPInvExpTGLC_GetBySysRowID] ******/

CREATE OR ALTER PROCEDURE [Erp].[_ZFW_APInvoiceAPInvExpTGLC_GetBySysRowID]
...
BEGIN
	...
	SET NOCOUNT ON;
---------------------------------------------------------------------
-- SELECT for table TranGLC AS APInvExpTGLC / Table Number : 1
---------------------------------------------------------------------
SELECT [t0].[Company],
[t0].[RelatedToFile],
[t0].[Key1],
