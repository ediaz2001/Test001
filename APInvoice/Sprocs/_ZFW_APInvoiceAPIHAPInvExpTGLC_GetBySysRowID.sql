/*** Object: StoredProcedure [Erp].[_ZFW_APInvoiceAPIHAPInvExpTGLC_GetBySysRowID] ******/

CREATE OR ALTER PROCEDURE [Erp].[_ZFW_APInvoiceAPIHAPInvExpTGLC_GetBySysRowID]
...
BEGIN
	...
	SET NOCOUNT ON;
---------------------------------------------------------------------
-- SELECT for table TranGLC AS APIHAPInvExpTGLC / Table Number : 1
---------------------------------------------------------------------
SELECT [t0].[Company],
[t0].[RelatedToFile],
[t0].[Key1],
...
ISNULL([L2].[GLAcctDisp], '') AS [GLAccountGLAcctDisp],
ISNULL([L2].[GLShortAcct], '') AS [GLAccountGLShortAcct],
