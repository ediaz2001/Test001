/*** Object: StoredProcedure [Erp].[_ZFW_APInvoiceAPInvHedMscTax_GetBySysRowID] ******/

CREATE OR ALTER PROCEDURE [Erp].[_ZFW_APInvoiceAPInvHedMscTax_GetBySysRowID]
...
BEGIN
	...
	SET NOCOUNT ON;
---------------------------------------------------------------------
-- SELECT for table APInvHedMscTax AS APInvHedMscTax / Table Number : 1
---------------------------------------------------------------------
SELECT [t0].[Company],
[t0].[VendorNum],
[t0].[InvoiceNum],
...
'' AS [DescCollectionType],
CAST(0 AS int) AS [InvoiceLine],
'' AS [GroupID],
CAST(0.0 AS decimal(20,9)) AS [DocScrDedTaxAmt],
CAST(0.0 AS decimal(20,9)) AS [DocScrFixedAmount],
...
CAST(0.0 AS decimal(20,9)) AS [Rpt1ScrFixedAmount],
...
CAST(0.0 AS decimal(20,9)) AS [Rpt2ScrFixedAmount],
...
CAST(0.0 AS decimal(20,9)) AS [Rpt3ScrFixedAmount],
...
CAST(0.0 AS decimal(20,9)) AS [ScrFixedAmount],
...
FROM [Erp].[APInvHedMscTax] AS [t0]
LEFT JOIN [Ice].[BitFlag] AS b1 ON b1.RelatedToSchemaName=N'Erp' AND b1.RelatedToTable=N'APInvHedMscTax' AND b1.RelatedToRowId = t0.SysRowID
