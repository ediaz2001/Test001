/*** Object: StoredProcedure [Erp].[_ZFW_ConfigurationRuntimePcValueInputLayerHeader_GetBySysRowID] ******/

CREATE OR ALTER PROCEDURE [Erp].[_ZFW_ConfigurationRuntimePcValueInputLayerHeader_GetBySysRowID]
...
BEGIN
	...
	SET NOCOUNT ON;
---------------------------------------------------------------------
-- SELECT for table PcValueInputLayerHeader AS PcValueInputLayerHeader / Table Number : 1
---------------------------------------------------------------------
SELECT [t0].[Company],
[t0].[GroupSeq],
[t0].[HeadNum],
